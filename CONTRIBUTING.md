...
- `Game.Rpc.Runtime`: transport abstraction + implementations (TCP / WebSocket / KCP / Loopback), framing, RPC core.
  - Unity sources: `samples/RpcCall/RpcCall.Unity/Assets/Scripts/Rpc/**`
...
- All contracts live in `samples/RpcCall/RpcCall.Unity/Packages/com.bruce.rpc.contracts/`.
- Server projects must include contracts by linking sources:
  ```xml
  <Compile Include="..\..\RpcCall.Unity\Packages\com.bruce.rpc.contracts\**\*.cs" />
  ```
